    ...
    bool is_last_batch)
{
    ...
    // --------------- Now compress the data_low_low using zstd --------------- //
    ...
    // --------------- Now compress the data_low_high using zstd --------------- //
    ...
    // std::memcpy(destination.data() + sizeof(compressed_keys_size) + compressed_keys_size, &compressed_data_ll_size, sizeof(compressed_data_ll_size));

    // // Copy compressed data_low_low 
    // std::memcpy(destination.data() + sizeof(compressed_keys_size) + compressed_keys_size + sizeof(compressed_data_ll_size), 
    //     compressed_data_ll->data(), compressed_data_ll_size);
    
    // // Copy the size of compressed data_low_high
    // std::memcpy(destination.data() + sizeof(compressed_keys_size) + compressed_keys_size + sizeof(compressed_data_ll_size) + compressed_data_ll_size, 
    //     &compressed_data_lh_size, sizeof(compressed_data_lh_size));
    
    // // Copy compressed data_low_high
    // std::memcpy(destination.data() + sizeof(compressed_keys_size) + compressed_keys_size + sizeof(compressed_data_ll_size) + compressed_data_ll_size
    //     + sizeof(compressed_data_lh_size), compressed_data_lh->data(), compressed_data_lh_size);
    
    // // Copy compressed data_high 
    // std::memcpy(destination.data() + sizeof(compressed_keys_size) + compressed_keys_size + sizeof(compressed_data_ll_size) + compressed_data_ll_size
    //     + sizeof(compressed_data_lh_size) + compressed_data_lh_size, compressed_data_h->data(), compressed_data_h_size);    

    // unsigned long compr_size =  sizeof(compressed_keys_size) + compressed_keys_size + sizeof(compressed_data_ll_size) + compressed_data_ll_size 
