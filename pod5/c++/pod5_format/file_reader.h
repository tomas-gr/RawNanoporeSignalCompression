...
public:
    ...
    virtual Status set_bam_file(const std::string & bam_file_path, const std::string & bam_index_file_path) = 0;
    virtual Status build_bam_idx() = 0;
    virtual Status load_levels(const std::string & levels_path) = 0;
};
