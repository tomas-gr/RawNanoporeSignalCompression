...
buf_sizes_VBZ encode(Int16T const * in, uint8_t * SVB_RESTRICT out, uint32_t count, Int16T prev = 0)
{
    auto const keys = out;
...
//     }
// #endif
    return encode_scalar<Int16T, UseDelta, UseZigzag>(in, keys, data, count, prev) ;
}
